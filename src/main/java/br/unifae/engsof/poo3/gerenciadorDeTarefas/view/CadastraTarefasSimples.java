 ...
 * @author Igor
 */
public class CadastraTarefasSimples extends javax.swing.JFrame {

    /**
     * Creates new form CadastraTarefas
     */
    public CadastraTarefasSimples() {
        initComponents();
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        if("".equals(descricao)){
            JOptionPane.showMessageDialog(null, "Campo descrição vazio", "Aviso", 0);
               ...
               JOptionPane.showMessageDialog(null, "Campo de data criação vazio ou incompleto", "Aviso", 0);
        } else {
            TarefaController tarefaController = new TarefaController();
            try {
                LocalDate dataCriacao = LocalDate.parse(data,DateTimeFormatter.ofPattern("dd/MM/yyyy"));
            
                if(tarefaController.addTarefaSimples(descricao,prioridade, dataCriacao)){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastraTarefasSimples().setVisible(true);
            }
        });
    }
